...
/obj/item/gun/projectile/automatic/assault_rifle/minigun
    name = "minigun"
    desc = "The rugged GPM-45 is a durable automatic weapon of a make popular on the more hostile frontier worlds. Originally produced by Calvinsky Technology. The serial number has been scratched off."
    icon = 'icons/obj/guns/minigun.dmi'
    icon_state = "minigun"
    item_state = "minigun"
    w_class = ITEM_SIZE_LARGE  //for debugging purpose
    force = 10
    slot_flags = SLOT_BACK|SLOT_BELT
    load_method = MAGAZINE
    magazine_type = /obj/item/ammo_magazine/box/machinegun/minigun
    allowed_magazines = /obj/item/ammo_magazine/box/machinegun/minigun
    one_hand_penalty = 10
    accuracy_power = 20
    accuracy = 10

/obj/item/gun/projectile/automatic/assault_rifle/minigun/on_update_icon()
	..()
	if(ammo_magazine)
		icon_state = "minigun"
		wielded_item_state = "minigun-wielded"
	else
		icon_state = "minigun-empty"
		wielded_item_state = "miingun-wielded"
