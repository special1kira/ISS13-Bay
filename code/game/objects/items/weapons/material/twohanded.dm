...
/obj/item/material/twohanded/fireaxe/sunke
	icon = 'icons/obj/weapons/melee_physical.dmi'
	icon_state = "fireaxe0"
	base_icon = "fireaxe"
	name = "Unholy axe"
	desc = "If you see it. Run"

	max_force = 80	//for wielded
	force_multiplier = 0.6
	unwielded_force_divisor = 0.3
	sharp = TRUE
	edge = TRUE
...
/obj/item/material/twohanded/fireaxe/sunke/afterattack(atom/A as mob|obj|turf|area, mob/user as mob, proximity)
	if(!proximity) return
	..()
	if(A && wielded)
		if(istype(A,/obj/structure/window))
...
/obj/item/material/twohanded/fireaxe/sunke/ishatchet()
	return TRUE
