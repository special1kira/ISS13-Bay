...
/obj/item/clothing/head/culthood/sunke
	name = "cult hood"
	icon_state = "culthood"
	desc = "An Armored hood worn by followers of Honk Mother."
	flags_inv = HIDEFACE
	body_parts_covered = HEAD
	armor = list(
...
/obj/item/clothing/suit/cultrobes/sunke
	name = "cult robes"
	desc = "A set of durable robes worn by the followers of Honk Mother."
	icon_state = "cultrobes"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	allowed = list(/obj/item/book/tome,/obj/item/melee/cultblade)
	armor = list(
